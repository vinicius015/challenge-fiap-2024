...
import 'package:euron_management_portal/src/presentation/pages/training/signing/create_signing_request_page.dart';
import 'package:euron_management_portal/src/presentation/pages/training/signing/search_signing_request_page.dart';
import 'package:euron_management_portal/src/presentation/pages/training/signing/search_signings_page.dart';
import 'package:flutter/material.dart';

class TrainingPage extends StatefulWidget {
  final bool isAdmin;
  const TrainingPage({super.key, required this.isAdmin});
                ...
                ElevatedButton(
                    onPressed: () => {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      const SearchSigningRequestsPage()))
                        },
                    style: ElevatedButton.styleFrom(
                        minimumSize: const Size(400, 60),
                        backgroundColor: euronSoftPurple,
                    ...
                    child: const Text('Minhas Assinaturas',
                        style: TextStyle(fontSize: 20))),
              ]
            ],
          ),
